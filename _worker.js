...
function getVLESSConfig(userID, hostName) {
  ...
  const note = `鐢摜鍗氬鍦板潃锛歨ttps://ygkkk.blogspot.com\n鐢摜YouTube棰戦亾锛歨ttps://www.youtube.com/@ygkkk\n鐢摜TG鐢垫姤缇ょ粍锛歨ttps://t.me/ygkkktg\n鐢摜TG鐢垫姤棰戦亾锛歨ttps://t.me/ygkkktgpd\n\nProxyIP鍏ㄥ眬杩愯涓細${proxyIP}`;
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1>Cloudflare-workers/pages-vless浠ｇ悊鑴氭湰 V24.10.18</h1>
	    <hr>
            <p>${noteshow}</p>
            <hr>
	    <hr>
	    <hr>
            <br>
            <br>
            <h3>1锛欳F-workers-vless+ws鑺傜偣</h3>
			<table class="table">
				<thead>
					<tr>
						<th>鑺傜偣鐗硅壊锛�</th>
				...
				<tbody>
					<tr>
						<td class="limited-width">鍏抽棴浜員LS鍔犲瘑锛屾棤瑙嗗煙鍚嶉樆鏂�</td>
						<td class="limited-width">${wvlessws}</td>
						<td><button class="btn btn-primary" onclick="copyToClipboard('${wvlessws}')">鐐瑰嚮澶嶅埗閾炬帴</button></td>
					</tr>
				</tbody>
			</table>
            <h5>瀹㈡埛绔弬鏁板涓嬶細</h5>
            <ul>
                <li>瀹㈡埛绔湴鍧€(address)锛氳嚜瀹氫箟鐨勫煙鍚� 鎴栬€� 浼橀€夊煙鍚� 鎴栬€� 浼橀€塈P 鎴栬€� 鍙嶄唬IP</li>
                <li>绔彛(port)锛�7涓猦ttp绔彛鍙换鎰忛€夋嫨(80銆�8080銆�8880銆�2052銆�2082銆�2086銆�2095)锛屾垨鍙嶄唬IP瀵瑰簲绔彛</li>
                <li>鐢ㄦ埛ID(uuid)锛�${userID}</li>
                <li>浼犺緭鍗忚(network)锛歸s 鎴栬€� websocket</li>
                <li>浼鍩熷悕(host)锛�${hostName}</li>
                <li>璺緞(path)锛�/?ed=2560</li>
		<li>浼犺緭瀹夊叏(TLS)锛氬叧闂�</li>
            </ul>
            <hr>
			<hr>
			<hr>
            <br>
            <br>
            <h3>2锛欳F-workers-vless+ws+tls鑺傜偣</h3>
			<table class="table">
				<thead>
					<tr>
						<th>鑺傜偣鐗硅壊锛�</th>
				...
				<tbody>
					<tr>
						<td class="limited-width">鍚敤浜員LS鍔犲瘑锛�<br>濡傛灉瀹㈡埛绔敮鎸佸垎鐗�(Fragment)鍔熻兘锛屽缓璁紑鍚紝闃叉鍩熷悕闃绘柇</td>
						<td class="limited-width">${pvlesswstls}</td>	
						<td><button class="btn btn-primary" onclick="copyToClipboard('${pvlesswstls}')">鐐瑰嚮澶嶅埗閾炬帴</button></td>
					</tr>
				</tbody>
			</table>
            <h5>瀹㈡埛绔弬鏁板涓嬶細</h5>
            <ul>
                <li>瀹㈡埛绔湴鍧€(address)锛氳嚜瀹氫箟鐨勫煙鍚� 鎴栬€� 浼橀€夊煙鍚� 鎴栬€� 浼橀€塈P 鎴栬€� 鍙嶄唬IP</li>
                <li>绔彛(port)锛�6涓猦ttps绔彛鍙换鎰忛€夋嫨(443銆�8443銆�2053銆�2083銆�2087銆�2096)锛屾垨鍙嶄唬IP瀵瑰簲绔彛</li>
                <li>鐢ㄦ埛ID(uuid)锛�${userID}</li>
                <li>浼犺緭鍗忚(network)锛歸s 鎴栬€� websocket</li>
                <li>浼鍩熷悕(host)锛�${hostName}</li>
                <li>璺緞(path)锛�/?ed=2560</li>
                <li>浼犺緭瀹夊叏(TLS)锛氬紑鍚�</li>
                <li>璺宠繃璇佷功楠岃瘉(allowlnsecure)锛歠alse</li>
			</ul>
			<hr>
			<hr>
			<hr>
			<br>	
			<br>
			<h3>3锛氳仛鍚堥€氱敤銆丆lash-meta銆丼ing-box璁㈤槄閾炬帴濡備笅锛�</h3>
			<hr>
			<p>娉ㄦ剰锛�<br>1銆侀粯璁ゆ瘡涓闃呴摼鎺ュ寘鍚玊LS+闈濼LS鍏�13涓鍙ｈ妭鐐�<br>2銆佸綋鍓峸orkers鍩熷悕浣滀负璁㈤槄閾炬帴锛岄渶閫氳繃浠ｇ悊杩涜璁㈤槄鏇存柊<br>3銆佸浣跨敤鐨勫鎴风涓嶆敮鎸佸垎鐗囧姛鑳斤紝鍒橳LS鑺傜偣涓嶅彲鐢�</p>
			<hr>
			<table class="table">
					<thead>
						<tr>
					...
					<tbody>
						<tr>
							...
							<td><button class="btn btn-primary" onclick="copyToClipboard('${ty}')">鐐瑰嚮澶嶅埗閾炬帴</button></td>
						</tr>
					</tbody>
				</table>	
				...
				<table class="table">
						<thead>
							<tr>
								<th>Clash-meta璁㈤槄閾炬帴锛�</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td class="limited-width">${cl}</td>	
								<td><button class="btn btn-primary" onclick="copyToClipboard('${cl}')">鐐瑰嚮澶嶅埗閾炬帴</button></td>
							</tr>
						</tbody>
					</table>
					...
					<thead>
						<tr>
							<th>Sing-box璁㈤槄閾炬帴锛�</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td class="limited-width">${sb}</td>	
							<td><button class="btn btn-primary" onclick="copyToClipboard('${sb}')">鐐瑰嚮澶嶅埗閾炬帴</button></td>
						</tr>
					</tbody>
				</table>
				<br>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <br>
            <br>
            <h3>1锛欳F-pages/workers/鑷畾涔夊煙-vless+ws+tls鑺傜偣</h3>
			<table class="table">
				<thead>
					<tr>
						<th>鑺傜偣鐗硅壊锛�</th>
				...
				<tbody>
					<tr>
						<td class="limited-width">鍚敤浜員LS鍔犲瘑锛�<br>濡傛灉瀹㈡埛绔敮鎸佸垎鐗�(Fragment)鍔熻兘锛屽彲寮€鍚紝闃叉鍩熷悕闃绘柇</td>
						<td class="limited-width">${pvlesswstls}</td>
						<td><button class="btn btn-primary" onclick="copyToClipboard('${pvlesswstls}')">鐐瑰嚮澶嶅埗閾炬帴</button></td>
					</tr>
				</tbody>
            ...
            <br>
            <br>
			<h3>2锛氳仛鍚堥€氱敤銆丆lash-meta銆丼ing-box璁㈤槄閾炬帴濡備笅锛�</h3>
			<hr>
			<p>娉ㄦ剰锛氫互涓嬭闃呴摼鎺ヤ粎6涓猅LS绔彛鑺傜偣</p>
			<hr>
			<table class="table">
					<thead>
						<tr>
					...
					<tbody>
						<tr>
							...
							<td><button class="btn btn-primary" onclick="copyToClipboard('${pty}')">鐐瑰嚮澶嶅埗閾炬帴</button></td>
						</tr>
					</tbody>
				</table>	
				...
				<table class="table">
						...
						<tbody>
							<tr>
								...
								<td><button class="btn btn-primary" onclick="copyToClipboard('${pcl}')">鐐瑰嚮澶嶅埗閾炬帴</button></td>
							</tr>
						</tbody>
					</table>
					...
					<tbody>
						<tr>
							...
							<td><button class="btn btn-primary" onclick="copyToClipboard('${psb}')">鐐瑰嚮澶嶅埗閾炬帴</button></td>
						</tr>
					</tbody>
				</table>
				<br>
